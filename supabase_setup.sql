...
-- =====================================================================================
-- SKEMA BARU: SHIPPING RATES (MANUAL INTERNAL)
-- =====================================================================================
...
CREATE TABLE IF NOT EXISTS public.shipping_rates (
    ...
    extra_per_kg NUMERIC NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS public.shipping_settings (
    ...
    recommended_shipping_enabled BOOLEAN NOT NULL DEFAULT true,
    updated_at TIMESTAMP WITH TIME ZONE DEFAULT timezone('utc'::text, now()) NOT NULL
);
...
DROP POLICY IF EXISTS "Allow authenticated read shipping rates" ON public.shipping_rates;
CREATE POLICY "Allow authenticated read shipping rates"
ON public.shipping_rates
FOR SELECT
TO authenticated
USING (true);

DROP POLICY IF EXISTS "Allow admin full access to shipping rates" ON public.shipping_rates;
...
DROP POLICY IF EXISTS "Allow authenticated read shipping settings" ON public.shipping_settings;
CREATE POLICY "Allow authenticated read shipping settings"
ON public.shipping_settings
FOR SELECT
TO authenticated
USING (true);

DROP POLICY IF EXISTS "Allow admin full access to shipping settings" ON public.shipping_settings;
CREATE POLICY "Allow admin full access to shipping settings"
ON public.shipping_settings
FOR ALL
USING (is_admin())
WITH CHECK (is_admin());
